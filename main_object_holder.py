...
class PairingResults:
    def __init__(self, unique_kmers, kmer_combinations,
                 matched_probas, probas_0, probas_1, mapped_kmers,
                 pairwise_ranks,
                 selected_indices
                 ):
        ...
        self.chosen_combination_indices = selected_indices
        self.all_ranks = pairwise_ranks
    ...
    def save(self, path):
        ...
        np.save(os.path.join(path, "all_ranks.npy"), self.all_ranks)
        np.save(os.path.join(path, "chosen_combination_indices.npy"), self.chosen_combination_indices)
...
class PairingBasedSimilarityCalculator:
    ...
    def __calculate_kmer_to_kmer_similarities(self, unique_kmers, full_metrics):
        ...
        return selected_kmer_combinations, selected_match_proba, selected_mismatch_proba, selected_total_match_proba, pairwise_ranks, selected_indices
    ...
    def __fit(self, sequence_df):
        ...
        # kmer to kmer scores
        kmer2kmer = self.__calculate_kmer_to_kmer_similarities(
            unique_kmers, full_metrics)
        selected_kmer_combinations, selected_match_proba, selected_mismatch_proba, selected_total_match_proba, pairwise_ranks, selected_indices = kmer2kmer
